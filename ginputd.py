...
class GInput:
  def __init__(self,x,y,width,height,placeholder="",borderWidth=1,placeholderColor=(127,127,127),borderColor=(0,0,0),fillColor=(0,0,255),textColor=(0,0,0)):
  ...
  def _draw(self,borderColor,fillColor):
    ...
    draw_string(self._placeholder,self._x+((self._width-self._borderWidth*2)-len(self._placeholder)*10)//2,self._y+(self._height-15)//2,self._placeholderColor,fillColor)
